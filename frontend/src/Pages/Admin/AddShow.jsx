...
const AddShow = () => {
  ...
  const handleSubmit = async () =>{
    try{
      setAddingShow(true)
      if(!selctedMovie || Object.keys(dateTimeSelection).length === 0 || !showPrice)
{
...
const payload = {
  ...
  return nowPlayingMovies.length > 0 ? (
    ...
    <div className='overflow-x-auto pb-4'>
      <div className='group flex flex-wrap gep-4 mt-4 w-max'>
    ...
    <div className='mt-6'>
      ...
      p-1 pl-3 rounded-lg'>
        ...
        py-2 text-sm rounded-lg hover:bg-primary cursor-pointer'> Add Time
