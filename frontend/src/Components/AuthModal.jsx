...
const AuthModal = () => {
  ...
  const [adminKey, setAdminKey] = useState("ShowTimeApp");
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  required
                  placeholder="Enter Master Admin Key (e.g. ShowTimeApp)"
                  value={adminKey}
                  onChange={(e) => setAdminKey(e.target.value)}
                  className="w-full bg-gray-950 border border-amber-500/50 rounded-xl pl-10 pr-4 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-amber-500 transition"
                />
              </div>
            </div>
